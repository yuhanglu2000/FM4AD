...
data_root = '/inspurfs/group/mayuexin/luyh/datasets/nuScenes/data/'
...
train_pipeline = [
    ...
    dict(type='CustomCollect3D',\
         keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'ego_his_trajs',
               'ego_fut_trajs', 'ego_fut_masks', 'ego_fut_cmd', 'ego_lcf_feat', 'gt_attr_labels', 'pos_traj', 'neg_traj'])
]
        ...
        transforms=[
            ...
            dict(type='CustomCollect3D',\
                 keys=['points', 'gt_bboxes_3d', 'gt_labels_3d', 'img', 'fut_valid_flag',
                       ...
                       'ego_lcf_feat', 'gt_attr_labels', 'pos_traj', 'neg_traj'])])
]
...
data = dict(
    ...
    train=dict(
        ...
        vlm_traj_file=data_root + "vlm_traj.json",
