...
class VADCustomNuScenesDataset(NuScenesDataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.vlm_traj_file = vlm_traj_file
        if vlm_traj_file != None:
            with open(vlm_traj_file, 'r') as f:
                self.vlm_trajs = json.load(f)
    ...
    def get_data_info(self, index):
        ...
        if self.vlm_traj_file != None:
            input_dict["pos_traj"] = np.array(self.vlm_trajs[input_dict['sample_idx']]['pos_traj'])
            input_dict["neg_traj"] = np.stack(self.vlm_trajs[input_dict['sample_idx']]['neg_traj'])
